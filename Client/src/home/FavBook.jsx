    ...
    return (
        <div className='px-4 lg:px-24 my-20 flex flex-col md:flex-row justify-between items-center gap-12'>
            ...
            <div className='md:w-1/2 space-y-6'>
                ...
                Officia a beatae non veniam accusantium magni ducimus voluptates maxime, rerum adipisci pariatur minima! Quia voluptatum,
                repudiandae quidem illum quam repellat officiis.</p>
